...
public class BandCat : Cat
{



    private Dictionary<CatType.Type, EvolutionMaterialInventory> band_cat_evolution_requirements = new Dictionary<CatType.Type, EvolutionMaterialInventory>()
    {
    ...
    public override IDictionary<CatType.Type, EvolutionMaterialInventory> evolution_requirements
    {
        get
        {
            return band_cat_evolution_requirements;
        }
    }
    ...
    protected override void InitializeCatType()
    {
        ...
        this.type = CatType.Type.band_cat;
    }
