...
public class DentistCat : Cat
{



    private Dictionary<CatType.Type, EvolutionMaterialInventory> dentist_cat_evolution_requirements = new Dictionary<CatType.Type, EvolutionMaterialInventory>()
    {
    ...
    public override IDictionary<CatType.Type, EvolutionMaterialInventory> evolution_requirements
    {
        get
        {
            return dentist_cat_evolution_requirements;
        }
    }
    ...
    protected override void InitializeCatType()
    {
        ...
        this.type = CatType.Type.dentist_cat;
    }
