...
public class CameraManager : MonoBehaviour
{
    ...
    public void EnableWorldCamera()
    {
        ...
        HQCamera.gameObject.SetActive(false);
    }
    ...
    public void EnableARCamera()
    {
        ...
        if(isInitialized)
        {
            TutorialManager.instance?.UnlockTutorial(TutorialManager.Type.ar_camera);
        }
    ...
    public void EnableHQCamera()
    {
        WorldCamera.gameObject.SetActive(false);
        ARCamera.gameObject.SetActive(false);
        HQCamera.gameObject.SetActive(true);
    }
