...
public class Timers : MonoBehaviour
{
    ...
    public class CatJumpCooldown : Timer
    {
        public catAgent cat
        {
            get; private set;
        }
        public CatJumpCooldown(catAgent _cat) : base(5.5f, false)
        {
            cat = _cat;
        }
    ...
    public Dictionary<catAgent, CatJumpCooldown> catJumpCooldownList = new Dictionary<catAgent, CatJumpCooldown>();
    ...
    public void StartCatJumpCooldown(catAgent cat)
    {
        CatJumpCooldown cjc = new CatJumpCooldown(cat);
        catJumpCooldownList[cat] = cjc;
        timers.Add(cjc);
    }
