...
public class DoctorCat : Cat
{



    private Dictionary<CatType.Type, EvolutionMaterialInventory> doctor_cat_evolution_requirements = new Dictionary<CatType.Type, EvolutionMaterialInventory>()
    {
    ...
    public override IDictionary<CatType.Type, EvolutionMaterialInventory> evolution_requirements
    {
        get
        {
            return doctor_cat_evolution_requirements;
        }
    }
