...
public class SecurityCat : Cat
{



    private Dictionary<CatType.Type, EvolutionMaterialInventory> security_cat_evolution_requirements = new Dictionary<CatType.Type, EvolutionMaterialInventory>()
    {
    ...
    public override IDictionary<CatType.Type, EvolutionMaterialInventory> evolution_requirements
    {
        get
        {
            return security_cat_evolution_requirements;
        }
    }
