...
public class ScholarCat : Cat
{



    private Dictionary<CatType.Type, EvolutionMaterialInventory> scholar_cat_evolution_requirements = new Dictionary<CatType.Type, EvolutionMaterialInventory>()
    {
    ...
    public override IDictionary<CatType.Type, EvolutionMaterialInventory> evolution_requirements
    {
        get
        {
            return scholar_cat_evolution_requirements;
        }
    }
    ...
    protected override void InitializeCatType()
    {
        ...
        this.type = CatType.Type.scholar_cat;
    }
